...
public class MqttLog {
    ...
    public static String format(String header, String content) {
        String[] items = split(content, MqttLog.HEAD_LINE.length());
    ...
    public static String format(String header, String contents[]) {
        ...
        sb.append(MqttLog.NEW_LINE).append(MqttLog.HEAD_LINE).append(MqttLog.NEW_LINE);
        sb.append(MqttLog.LEFT_LINE).append(header).append(MqttLog.NEW_LINE);
        sb.append(MqttLog.MIDDLE_LINE).append(MqttLog.NEW_LINE);
        for (int i = 0; i < contents.length; i++) {
            sb.append(MqttLog.LEFT_LINE).append(contents[i]).append(MqttLog.NEW_LINE);
        }
        sb.append(MqttLog.BOTTOM_LINE);
        return sb.toString();
    }
