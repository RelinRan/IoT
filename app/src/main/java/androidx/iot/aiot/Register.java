...
public class Register implements Runnable{
    ...
    public Register(String url, String instanceId, String productKey, String productSecret, String deviceName, MqttCallback mqttCallback, DynamicHandler handler, ConcurrentHashMap<Long, OnDynamicListener> map) {
        this.url = url;
