    ...
    override fun messageArrived(topic: String?, message: MqttMessage?) {
        ...
        when (topic) {
            ...
            topics().SUB_BOOTSTRAP_NOTIFY() -> {
                val message: androidx.iot.data.Publish<DeviceDistributionNotification> = gson.fromJson(
                    payload,
                    object : TypeToken<androidx.iot.data.Publish<DeviceDistributionNotification>>() {}.type,
                )
